...
constructor(private val fragmentManager: android.support.v4.app.FragmentManager,
    ...
    override fun openFragment(baseFragment: BaseFragment, option: FragmentHandler.Option
                              , isToBackStack: Boolean, tag: String, sharedElements: List<Pair<View, String>>?) {
