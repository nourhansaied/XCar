...
import com.victoria.customer.ui.home.adapter.PaymentHistoryAdapter
import com.victoria.customer.ui.home.adapter.TransactionHistoryAdapter
import com.victoria.customer.ui.home.viewmodel.FareEstimationViewModel
import com.victoria.customer.util.DateUtipPicker
import com.victoria.customer.util.DialogUtils
...
class TransactionHistoryFragment : BaseFragment() {
    ...
    @Inject
    lateinit var validator: com.victoria.customer.core.Validator
    ...
    private fun createDialogWithoutDateField(): DatePickerDialog {
        val dpd = DatePickerDialog.newInstance { _, selectedYear, monthOfYear, dayOfMonth ->
