...
constructor() : GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener, ResultCallback<LocationSettingsResult> {
    ...
    private fun checkPermission(): Boolean {
        return activity != null && ActivityCompat.checkSelfPermission(activity!!, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(activity!!, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED
    }
    ...
    companion object {
        ...
        private const val REQUEST_CHECK_PERMISSION = 222
        // Location updates intervals in sec
        private const val UPDATE_INTERVAL = 3000 // 3 sec
        private const val FATEST_INTERVAL = 3000 // 3 sec
        private const val DISPLACEMENT = 100 // 1 meters
    }
}