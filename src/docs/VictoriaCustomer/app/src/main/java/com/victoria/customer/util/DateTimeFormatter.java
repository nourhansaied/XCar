...
public class DateTimeFormatter {
    ...
    public static String localToUtcConvert(String dateString, String inputDateFormat, String outputDateFormat) {
        String dateStr = dateString;
        SimpleDateFormat df = new SimpleDateFormat(inputDateFormat, Locale.ENGLISH);
        ...
        SimpleDateFormat dfOut = new SimpleDateFormat(outputDateFormat, Locale.ENGLISH);
