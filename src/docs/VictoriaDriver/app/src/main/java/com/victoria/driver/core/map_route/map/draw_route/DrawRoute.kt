package com.victoria.driver.core.map_route.map.draw_route
...
import com.victoria.driver.core.map_route.map.PathUpdateListener
                ...
                override fun onResult(result: DirectionsResult) {
                    ...
                    this@DrawRoute.context?.runOnUiThread {
                        ...
                        if (updateTimeAndDistance != null) {
                            ...
                            if(result!=null && result.routes!=null && result.routes.size>0 && result.routes[0].legs!=null && result.routes[0].legs.size>0) {
