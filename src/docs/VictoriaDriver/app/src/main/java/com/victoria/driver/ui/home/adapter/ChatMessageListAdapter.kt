...
class ChatMessageListAdapter(private val context: Context
    ...
    override fun getItemViewType(position: Int): Int {
        ...
        if (sender_id.equals(session.user?.userType + session.user?.driverId.toString(), ignoreCase = true)) {
    ...
    class ChatViewHolderReceiver(override val containerView: View) : RecyclerView.ViewHolder(containerView), LayoutContainer {
        init {
            var textViewDate = containerView.findViewById<AppCompatTextView>(R.id.textViewDateRec)
    ...
    class ChatViewHolderSender(override val containerView: View) : RecyclerView.ViewHolder(containerView), LayoutContainer {
        init {
            var textViewDate = containerView.findViewById<AppCompatTextView>(R.id.textViewDate)
    ...
    fun getDate(time: Long): String {
        ...
        var sdf = SimpleDateFormat(Common.DATE_TIME_FORMAT_TIMER, Locale.ENGLISH)
