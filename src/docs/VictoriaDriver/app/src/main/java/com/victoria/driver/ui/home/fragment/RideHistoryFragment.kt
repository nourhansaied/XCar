...
import com.victoria.driver.ui.home.adapter.ViewPagerAdapter
import kotlinx.android.synthetic.main.fragment_ride_history_layout.*
import kotlinx.android.synthetic.main.toolbar_with_menu.*

class RideHistoryFragment : BaseFragment() {

    override fun createLayout(): Int {
        return R.layout.fragment_ride_history_layout
    }
    ...
    override fun bindData() {
        ...
        radioGroupMyRide.setOnCheckedChangeListener { _, checkedId ->
