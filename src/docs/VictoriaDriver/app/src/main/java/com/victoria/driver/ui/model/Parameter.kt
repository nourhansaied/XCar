...
class Parameter : Serializable {
    ...
    lateinit var dropoff_latitude: String

    @SerializedName("dropoff_longitude")
    lateinit var dropoff_longitude: String

    @SerializedName("dropoff_address")
    lateinit var dropoff_address: String
    ...
    lateinit var routing_number: String
    ...
    lateinit var car_frontimage: String

    @SerializedName("car_backimage")
    lateinit var car_backimage: String


    @SerializedName("driving_license")
    lateinit var driving_license: String

    @SerializedName("vehicle_brand")
    lateinit var vehicle_brand: String

    @SerializedName("vehicle_model")
    lateinit var vehicle_model: String

    @SerializedName("vehicle_number")
    lateinit var vehicle_number: String

    @SerializedName("vehicle_color")
    lateinit var vehicle_color: String
    ...
    lateinit var allowGender: String
}