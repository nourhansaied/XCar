...
import com.victoria.driver.ui.viewmodel.ChangePasswordViewModel
...
class LanguageChangeFragment : BaseFragment() {
    ...
    private fun handleChangePasswordResponse(responseBody: com.victoria.driver.data.pojo.ResponseBody<Unit>) {
